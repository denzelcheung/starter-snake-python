...
def move():
    ...
    head_x = snake['head']['x']
    head_y = snake['head']['y']
    if (board[head_x+1][head_y] is 0 or 5) and (board[head_x+1][head_y] < data['board']['width']):
        return move_response(directions[3])
    elif (board[head_x-1][head_y] is 0 or 5) and head_x-1 > 0:
        return move_response(directions[1])
    elif (board[head_x][head_y+1] is 0 or 5) and (board[head_x][head_y+1] < data['board']['height']):
        return move_response(directions[2])
    elif (board[head_x][head_y-1] is 0 or 5) and head_y-1 > 0:
